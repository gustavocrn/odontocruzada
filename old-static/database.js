// Banco de Dados do Jogo de Palavras Cruzadas Odontológicas
// Contém 50 fases, com 10 palavras únicas cada (totalizando 500 palavras exclusivas).
// Estrutura global para compatibilidade local via file://

const OdontoDatabase = [
  ...
  },
  {
    ...
    words: [
      ...
      { word: "QUERATINOCITO", clue: "Célula que produz queratina na gengiva.", explanation: "Célula predominante na gengiva inserida, conferindo rigidez e barreira protetora à mucosa." },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "EXPLORADOR", clue: "Sonda de duas pontas finas de detecção.", explanation: "Instrumento metálico pontiagudo para rastrear imperfeições no esmalte e margens de restaurações." },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "ALGINATOEMPO", clue: "Apresentação seca do material de moldagem.", explanation: "Forma em pó de alginato de sódio que requer hidratação para gelificar." },
  ...
  // --- BLOCO 6: ENDODONTIA (FASES 26 A 30) ---
  {
    ...
    words: [
      ...
      { word: "OBTURACAO", clue: "Preenchimento hermético do canal limpo.", explanation: "Vedação do conduto radicular com cones de guta-percha e cimento endodôntico." },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "DILACERACAO", clue: "Curvatura excessiva na raiz do dente.", explanation: "Desvio anatômico angulado na trajetória da raiz, exigindo grande perícia na instrumentação." },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "IMPLANTEZIGOMATICO", clue: "Implante longo fixado na bochecha (osso zigomático).", explanation: "Pino metálico longo ancorado no osso da maçã do rosto, indicado para perdas maxilares extremas." },
