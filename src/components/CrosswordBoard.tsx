             ...
             row.map((cell, x) => {
               ...
               return (
                 <div
                   ...
                   style={{ width: `${cellSize}px`, height: `${cellSize}px` }}
                   className={`relative rounded-md border transition-all duration-150 flex items-center justify-center cursor-pointer ${
                     isCellSolved
                       ? theme === "dark"
                         ? "bg-emerald-500/20 border border-emerald-500 text-emerald-450 font-extrabold correct-pulse"
                         : "bg-emerald-50 border border-emerald-500 text-emerald-600 font-extrabold correct-pulse"
                       : isCellIncorrect
                       ? theme === "dark"
                         ? "bg-red-500/25 border border-red-500 text-red-400"
                         : "bg-red-50 border border-red-500 text-red-600"
                       : isFocused
                       ? "bg-[#ffee58] border-2 border-[#fbc02d] text-slate-900 shadow-md ring-2 ring-[#ffee58]/55 scale-105 z-10"
                       : inActiveWord
                       ? theme === "dark"
                         ? "bg-[#0d47a1]/40 border border-[#1565c0] text-slate-100"
                         : "bg-[#bbdefb]/70 border border-[#90caf9] text-slate-900"
                       : theme === "dark"
                       ? "bg-slate-800 border border-slate-700 text-slate-100 hover:border-slate-500"
